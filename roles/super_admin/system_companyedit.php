...
if (!isset($_GET['id'])) {
    header("Location: system_companies.php");
    exit;
}
...
if (!$company) {
    header("Location: system_companies.php?error=Company not found");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = updateCompany($company_id, $name, $address, $phone);
...
<body>
    <div class="container mt-4">
        <div class="company-edit-card">
            <div class="card-header company-edit-header py-3">
            ...
            <div class="card-body p-4">
                ...
                <form action="company_edit.php?id=<?= $company_id ?>" method="POST">
                    <div class="mb-4">
