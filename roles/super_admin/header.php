...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="<?= ($activePage == 'task_management') ? 'active' : '' ?>">
                <a href="task_management.php"><i class="fas fa-tasks"></i><span> Task Management</span></a>
            </li>
            <li class="<?= ($activePage == 'time_management') ? 'active' : '' ?>">
                <a href="time_management.php"><i class="fas fa-clock"></i><span> Time Management</span></a>
            </li>
            <li class="<?= ($activePage == 'event_management') ? 'active' : '' ?>">
                <a href="event_management.php"><i class="fas fa-calendar-day"></i><span> Event Management</span></a>
            </li>
            <li class="<?= ($activePage == 'user_management') ? 'active' : '' ?>">
                <a href="user_management.php"><i class="fas fa-users-cog"></i><span> User Management</span></a>
            </li>
            <li class="<?= ($activePage == 'payroll_management') ? 'active' : '' ?>">
                <a href="payroll_management.php"><i class="fas fa-money-check"></i><span> Payroll Management</span></a>
            </li>
            <li class="<?= (in_array($activePage, $systemPages) ? 'active' : '') ?>">
                <a href="#" class="dropdown-toggle">
                    <i class="fas fa-cogs"></i><span> System Management</span>
                </a>
                <ul class="submenu">
                    <li class="<?= ($activePage == 'position') ? 'active' : '' ?>">
                        <a href="systempositions.php"><span> Position</span></a>
                    </li>
                    <li class="<?= ($activePage == 'deduction') ? 'active' : '' ?>">
                        <a href="systemdeductions.php"><span> Deduction</span></a>
                    </li>
                    <li class="<?= ($activePage == 'bonuses') ? 'active' : '' ?>">
                        <a href="systembonuses.php"><span> Bonuses</span></a>
                    </li>
                    <li class="<?= ($activePage == 'bonuses') ? 'active' : '' ?>">
                        <a href="system_companies.php"><span> Companies</span></a>
                    </li>
                </ul>
            </li>
